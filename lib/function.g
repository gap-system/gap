...
##  <P/>
##  For a function implemented in the &GAP; kernel, this is the line in the
##  C source file at which the C function implementing <A>func</A> is defined,
##  and <Ref Func="EndlineFunc"/> returns <K>fail</K>. Note that the line
##  cannot always be determined, e.g. if that C function is generated by a
...
BIND_GLOBAL( "LocationFunc", function(func)
    ...
    # for kernel functions whose definition we cannot locate in the source
    # (e.g. because they are generated by a C macro), fall back to naming the
    # C function implementing them
