...
##
AbelianNumberFieldByReducedGaloisStabilizerInfo := function( F, N, stab )
...
InstallMethod( PrintObj,
    "method for cyclotomic field of cyclotomics",
    true,
...
##
InstallMethod( \=,
    "method for two abelian number fields",
    IsIdentical,
...
##
InstallMethod( \in,
    "method for cyclotomic and abelian number field",
    IsElmsColls,
...
InstallMethod( \in,
    "method for cyclotomic and cyclotomic field",
    IsElmsColls,
...
InstallMethod( Intersection2,
    "method for two cyclotomic fields of cyclotomics",
    IsIdentical,
...
InstallMethod( Intersection2,
    "method for cyclotomic field and abelian number field",
    IsIdentical,
    [ IsCyclotomicField and IsCyclotomicsCollection,
      IsAbelianNumberField and IsCyclotomicsCollection ], 0,
    function ( F, G )
...
InstallMethod( Intersection2,
    "method for abelian number field and cyclotomic field",
    IsIdentical,
...
InstallOtherMethod( FieldExtension,
    "method for abelian number field of cyclotomics, and univ. polynomial",
    true,
#T CollPoly
    [ IsAbelianNumberField and IsCyclotomicsCollection,
...
InstallMethod( Conjugates,
    "method for abelian number field of cyclotomics, and cyclotomic",
    IsCollsElms,
...
InstallMethod( Conjugates,
    "method for cyclotomic field of cyclotomics, and cyclotomic",
    IsCollsElms,
...
InstallMethod( FieldByGenerators,
    "method for field and collection, both collections of cyclotomics",
    IsIdentical,
    [ IsField and IsCyclotomicsCollection, IsCyclotomicsCollection ], 0,
    function( F, gens )
...
InstallMethod( BasisVectors,
    "method for canon. basis of cyclotomic field of cyclotomics",
    true,
