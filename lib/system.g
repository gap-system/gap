...
# the user preference PackagesToLoad does the job      
    ...
    CommandLineOptionData := [
      ...
      rec( short:= "m", long := "initial-workspace", default := "128m", arg := "<mem>",
           help := ["set the initial workspace size"] ),
      rec( short:= "o", long := "warn-workspace", default := "2g", arg := "<mem>",
      ...
      rec( short:= "K", long := "maximal-workspace", default := "0", arg := "<mem>",
