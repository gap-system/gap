...
##############################################################################
##
#O  RightAlgebraModule( <A>, <op>, <gens> )
##
...
##############################################################################
##
#O  BiAlgebraModule( <A>, <B>, <opl>, <opr>, <gens> )
##
...
#O  TensorProduct( <V>, <W> )
##
##  Here <list> must be a list of Lie algebra modules. This function returns
##  the tensor product of the elements in the list (as a Lie algebra module).
##  The modules must be defined over the same Lie algebras.
##
...
##  exterior power of <V> (as an algebra module).
##
...
##  families.
##
DeclareOperation( "ExteriorPower", [ IsAlgebraModule, IsInt ] );
...
##
##  Elements of the symmetric power ${\rm Symm}^k(V)$ are
##  linear combinations of $v_{i_1}\cdots v_{i_k}$, where
##  the $v_{i_j}$ are basis elements of $V$, and
##  $1\leq i_1\leq i_2\cdots \leq i_k$. In {\GAP} a symmetric
##  element like that is printed as
##  \begintt
##     v_1.v_2 ... .v_k
##  \endtt
##  Furthermore, the zero of a symmetric power is printed as
##  \begintt
##   <0-symmetric element>
##  \endtt
##  This does not mean that all symmetric powers have the
##  same zero element: zeros of different symmetric powers have different
##  families.
##
DeclareOperation( "SymmetricPower", [ IsAlgebraModule, IsInt ] );
