...
**  The latter is accomplished by setting versions for libgap
**  in the libtool format (current:revision:age) in configure.ac
**  (cf. variables libgap_current, libgap_revision, libgap_age).
**
...
// config.h, which is generated by top-level configure script.
