...
EXPORT_INLINE Obj NEW_PERM2(UInt deg) GAP_GC_CANSAFEPOINT
{
...
EXPORT_INLINE Obj NEW_PERM4(UInt deg) GAP_GC_CANSAFEPOINT
{
...
*/
Obj OnTuplesPerm(Obj tup, Obj perm) GAP_GC_CANSAFEPOINT;
...
*/
Obj OnSetsPerm(Obj set, Obj perm) GAP_GC_CANSAFEPOINT;
...
*/
Obj Array2Perm(Obj array) GAP_GC_CANSAFEPOINT;
...
**  operation is valid.
*/
void TrimPerm(Obj perm, UInt m) GAP_GC_CANSAFEPOINT;
