...
#define T_CHANNEL		(FIRST_SHARED_TNUM+ 9)
#define T_BARRIER		(FIRST_SHARED_TNUM+ 10)
#define T_SYNCVAR		(FIRST_SHARED_TNUM+ 11)
#define T_FIXALIST		(FIRST_SHARED_TNUM+ 12)
#define T_ALIST			(FIRST_SHARED_TNUM+ 13)
#define T_AREC 			(FIRST_SHARED_TNUM+ 14)
#define T_AREC_INNER 		(FIRST_SHARED_TNUM+ 15)
#define T_TLREC 		(FIRST_SHARED_TNUM+ 16)
#define T_TLREC_INNER 		(FIRST_SHARED_TNUM+ 17)
