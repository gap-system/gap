...
#define T_ALIST			(FIRST_SHARED_TNUM+ 9)
#define T_AREC 			(FIRST_SHARED_TNUM+ 10)
#define T_AREC_INNER 		(FIRST_SHARED_TNUM+ 11)
#define T_TLREC 		(FIRST_SHARED_TNUM+ 12)
#define T_TLREC_INNER 		(FIRST_SHARED_TNUM+ 13)
#define T_ACOMOBJ 		(FIRST_SHARED_TNUM+ 14)
#define T_APOSOBJ 		(FIRST_SHARED_TNUM+ 15)
#define LAST_SHARED_TNUM	(T_APOSOBJ)
