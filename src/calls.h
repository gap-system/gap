...
EXPORT_INLINE Obj NAME_FUNC(Obj func GAP_GC_PROPAGATES_ROOT) GAP_GC_NOTSAFEPOINT
{
...
EXPORT_INLINE Obj NAMS_FUNC(Obj func GAP_GC_PROPAGATES_ROOT) GAP_GC_NOTSAFEPOINT
{
...
EXPORT_INLINE Obj PROF_FUNC(Obj func GAP_GC_PROPAGATES_ROOT) GAP_GC_NOTSAFEPOINT
{
...
EXPORT_INLINE Obj BODY_FUNC(Obj func GAP_GC_PROPAGATES_ROOT) GAP_GC_NOTSAFEPOINT
{
    return CONST_FUNC(func)->body;
}

EXPORT_INLINE Obj ENVI_FUNC(Obj func GAP_GC_PROPAGATES_ROOT) GAP_GC_NOTSAFEPOINT
{
    return CONST_FUNC(func)->envi;
}

#ifdef HPCGAP
EXPORT_INLINE Obj LCKS_FUNC(Obj func GAP_GC_PROPAGATES_ROOT) GAP_GC_NOTSAFEPOINT
{
