...
% %T currently unused, should go away
...
\def\TOCMatter{%
The pages are numbered chapterwise. This table of contents
gives for each section the page number within the chapter.
}
