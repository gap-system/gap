...
`\"internet config\"' &
  ...
  For some browsers (e.g., Internet Explorer), you may have to set the GAP 
  variable `HELP_MAC_PROTOCOL' to `file:/' for this to work correctly; in 
  this case, you may wish to do this in the `gap.rc' file (see 
  "The .gaprc file").
