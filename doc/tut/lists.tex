...
(1)~The new list is immutable, i.e., itself and its subobjects cannot be
    changed.
(2)~For that, every part of the list that can be changed has been copied,
    so that changes to the old list will not affect the new one. In other
    words, the new list has no mutable  subobjects in common with the old
    list.
\begintt
...
The notion `P1C0' means that the factors are univariate polynomials in
characteristic zero.
