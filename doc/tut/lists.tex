...
Since these entries  are subobjects of the immutable  old list  and hence
immutable themselves, the result of `ShallowCopy'  is mutable only at the
top level whereas the entries of the list are treated as constants, i.e.,
are not copied. That's why the result is called a ``shallow copy''.

\exercise How can you produce a ``deep copy'' of an immutable list?
