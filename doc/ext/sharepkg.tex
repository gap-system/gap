...
\indextt{init.g!for a share package}
...
\indextt{init.g!for a share package}
\indextt{read.g!for a share package}
...
\indextt{README!for a share package}
There  are  now  two  recognised  ways   of   producing   share   package
...
uses   the   \package{GAPDoc}    package    (see~"GAPDoc:Title    page").
