...
\package{GAPDoc}   package   for   their    documentation,    see
Chapter~"GAPDoc:Introduction and Example" in the \package{GAPDoc}  manual
or type
...
% The strange format is chosen in order not to mix up `doc/test/mktest.sh'.
e.g.
