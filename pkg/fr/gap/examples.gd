...
##
#H   @(#)$Id: examples.gd,v 1.26 2009/09/15 10:26:38 gap Exp $
##
...
##
##     <P/> This ring is graded; the attribute <C>Grading</C> is set.
## <Example><![CDATA[
## gap> a := PSZAlgebra(2);
## PSZAlgebra(GF(2))
