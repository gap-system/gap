#############################################################################
##  
##  PackageInfo.g for the package `recog'                     Max Neunhoeffer
##                                                                Akos Seress
...
# 
ArchiveURL := 
          "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/recog/recog",
...
#
README_URL := 
  "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/recog/README.recog",
PackageInfoURL := 
  "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/recog/PackageInfo.g",
...
PackageDoc := rec(
  ...
  Archive := 
      "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/recog/recogdoc.tar.gz",
  ...
  LongTitle := "recog - a framework for group recognition",
