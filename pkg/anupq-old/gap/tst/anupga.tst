#############################################################################
##
#A  anupga.tst               GAP share package                  Werner Nickel
##
...
##  not measure the time spend by the ANUPQ standalone.
##
...
[ [ Pcgs([ f1, f2, f3 ]) -> [ f1*f3, f2, f3 ], 
  ...
  [ Pcgs([ f1, f2, f3, f4 ]) -> [ f1*f3, f2, f3, f4 ], 
      ...
      Pcgs([ f1, f2, f3, f4 ]) -> [ f2, f1*f2, f4, f3*f4 ], 
  ...
  [ Pcgs([ f1, f2, f3, f4 ]) -> [ f1*f4, f2, f3, f4 ], 
      ...
      Pcgs([ f1, f2, f3, f4 ]) -> [ f1*f2, f2, f3, f4 ] ], 
  [ Pcgs([ f1, f2, f3*f4, f4 ]) -> [ f1, f2*f4, f3*f4, f4 ], 
      Pcgs([ f1, f2, f3*f4, f4 ]) -> [ f2, f1, f3, f4 ] ] ]
