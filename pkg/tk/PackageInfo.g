#############################################################################
##  
##  PackageInfo.g for the package `tk'                        Max Neunhoeffer
##                                                             Michael Ummels
##
##  $Id: PackageInfo.g,v 1.5 2003/08/19 13:27:52 gap Exp $
##                                                             
...
# 
ArchiveURL := "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/tk",
...
Persons := [
  ...
  rec( 
    ...
    WWWHome       := "http://www.ummels.de/work/en/index.html",
    PostalAddress := Concatenation( [
                       "Lehrstuhl D für Mathematik\n",
                       "RWTH Aachen\n",
                       "Templergraben 64\n",
...
#
README_URL := "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/Tk/README",
PackageInfoURL := "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/Tk/PackageInfo.g",
...
# utilities.",
AbstractHTML := 
  "The <span class=\"pkgname\">Tk</span> package provides a link from \
<span class=\"pkgname\">GAP</span> to the Tk toolkit, thereby allowing \
to display graphics from within the <span class=\"pkgname\">GAP</span> \
language.",

PackageWWWHome := "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/Tk",
...
PackageDoc := rec(
  ...
  Archive := 
      "http://www.math.rwth-aachen.de/~Max.Neunhoeffer/Tk/tk-0.5-doc.tar.gz",
...
AvailabilityTest := function()
  local path,file;
    ...
    file:=Filename(path,"wish");
    if file=fail then
      Info(InfoWarning,1,
        "Package ``tk'': The program `wish' is not installed");
      Info(InfoWarning,1,
        "`Tk' is thus unavailable");
      return false;
    fi;
    return true;
  end,
...
Keywords := ["graphics","GUI","graphical user interface","tk"]
