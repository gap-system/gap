...
# ".g" files is this directory, which are sourced by this script
# as needed.
#
# Adapted to GAP/Tk by Max Neunhoeffer 2002
#
# $Id: widget.g,v 1.2 2003/06/06 21:05:18 gap Exp $

# This is GAP/Tk-specific:
LoadPackage("Tk");
TkInit();

Tk("eval destroy [winfo child .]");
Tk("wm title . \"Widget Demonstration\"");
widgetDemo := 1;
...
font := "{Helvetica 14}";
menuBar := TkWidget("menu","-tearoff 0");
Tk(menuBar,"add cascade -menu .menuBar.file -label \"File\" -underline 0");
menuBar_file := TkWidget("menu",menuBar,"-tearoff 0");

# On the Mac use the specia .apple menu for the about item
if TkValue("$tcl_platform(platform)") = "macintosh" then
    Tk(menuBar,"add cascade -menu .menuBar.apple
