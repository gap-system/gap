#############################################################################
##
##  PkgInfo file for the FORMAT package.   Bettina Eick and Charles R.B. Wright
##
...
ArchiveURL := "http://www.uoregon.edu/~wright/RESEARCH/format-1.0",
...
PkgInfoURL := "http://www.uoregon.edu/~wright/RESEARCH/PkgInfo.g",
...
##  of the package.
Keywords := ["formations", "soluble", "group", "projector", "covering subgroup", "F-normalizer"]
