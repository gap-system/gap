#############################################################################
##  
##  PackageInfo.g for the package `GenSift'                   Max Neunhoeffer
##                                                             Cheryl Praeger
##                                                            Csaba Schneider
##
...
# 
ArchiveURL := 
          "http://www-groups.mcs.st-and.ac.uk/~neunhoef/Computer/Software/Gap/gensift/gensift-0.6.tar.gz",
...
Persons := [
  ...
  rec( 
    ...
    WWWHome       := "http://www.maths.uwa.edu.au/~praeger",
    PostalAddress := Concatenation( [ "" ] ),
    Place         := "Perth",
...
#
README_URL := 
  "http://www-groups.mcs.st-and.ac.uk/~neunhoef/Computer/Software/Gap/gensift/README.GenSift",
PackageInfoURL := 
  "http://www-groups.mcs.st-and.ac.uk/~neunhoef/Computer/Software/Gap/gensift/PackageInfo.g",
...
PackageWWWHome := "http://www-groups.mcs.st-and.ac.uk/~neunhoef/Computer/Software/Gap/gensift.html",
...
PackageDoc := rec(
  ...
  LongTitle := "GenSift - generalised sifting",
  Autoload  := true
),
...
Dependencies := rec(
  ...
  SuggestedOtherPackages := [["atlasrep",">= 1.3"],["ctbllib",">= 1.1"]],
...
##  of the package.
Keywords := ["generalized sift", "sporadic group"]
