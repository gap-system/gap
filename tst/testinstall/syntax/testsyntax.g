...
expect_trees := [
                  ...
                  rec( type := "T_FUNC_EXPR",
                       ...
                       narg := 0,
                       nloc := 1,
                       stats := rec( statements := [ rec( lvar := 1, rhs := rec( type := "T_TRUE_EXPR" ), type := "T_ASS_LVAR" ),
                                                     rec( lvar := 1, rhs := rec( type := "T_FALSE_EXPR" ), type := "T_ASS_LVAR" ),
                                                     rec( lvar := 1, rhs := rec( type := "T_INTEXPR", value := 5 ), type := "T_ASS_LVAR" ),
                                                     rec( lvar := 1, rhs := rec( type := "T_INT_EXPR", value := 500000000000000000000000000000 ), type := "T_ASS_LVAR" ),
                                                     rec( lvar := 1, rhs := rec( result := ' ', type := "T_CHAR_EXPR" ), type := "T_ASS_LVAR" ),
                                                     rec( lvar := 1, rhs := rec( string := "Hello, world", type := "T_STRING_EXPR" ), type := "T_ASS_LVAR" ),
                                                     rec( statements := [ rec( lvar := 1,
                                                                          ...
                                                                          rec( lvar := 1,
                                                                               ...
                                                                               type := "T_ASS_LVAR" ),
                                                                          rec( lvar := 1,
                                                                               rhs := rec( keyvalue := [ rec( key := "x", value := rec( type := "T_INTEXPR", value := 4 ) ) ], type := "T_REC_EXPR" ), type := "T_ASS_LVAR" ),
                                                                          rec( lvar := 1, rhs := rec( list := [ rec( type := "T_TILDE_EXPR" ) ], type := "T_LIST_TILD_EXPR" ), type := "T_ASS_LVAR" ),
                                                                          rec( lvar := 1, rhs := rec( type := "T_REC_TILD_EXPR" ), type := "T_ASS_LVAR" ),
                                                                          rec( type := "T_RETURN_VOID" ) ], type := "T_SEQ_STAT" ) ], type := "T_SEQ_STAT7" ) ),
                  # expr_test2
                  rec( type := "T_FUNC_EXPR",
                       variadic := false,
                       argnams := [  ], locnams := [ "x", "y", "z" ], name := "expr_test2", narg := 0, nloc := 3, 
                       stats := rec( statements := [ rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_OR" ), type := "T_ASS_LVAR" ), 
                                                     rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_AND" ), type := "T_ASS_LVAR" ), 
                                                     rec( lvar := 3, rhs := rec( op := rec( lvar := 1, type := "T_REFLVAR" ), type := "T_NOT" ), type := "T_ASS_LVAR" ), 
                                                     rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_EQ" ), type := "T_ASS_LVAR" ), 
                                                     rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_NE" ), type := "T_ASS_LVAR" ), 
                                                     rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_LT" ), type := "T_ASS_LVAR" ), 
                                                     rec( statements := [ rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_GT" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_LE" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_GE" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_IN" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_SUM" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( op := rec( lvar := 1, type := "T_REFLVAR" ), type := "T_AINV" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_DIFF" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_PROD" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_QUO" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( type := "T_INTEXPR", value := 1 ), right := rec( lvar := 1, type := "T_REFLVAR" ), type := "T_QUO" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_MOD" ), type := "T_ASS_LVAR" ), 
                                                                          rec( lvar := 3, rhs := rec( left := rec( lvar := 1, type := "T_REFLVAR" ), right := rec( lvar := 2, type := "T_REFLVAR" ), type := "T_POW" ), type := "T_ASS_LVAR" ), 
                                                                          rec( type := "T_RETURN_VOID" ) ], type := "T_SEQ_STAT" ) ], type := "T_SEQ_STAT7" )),
                  # stat_test_if
                  rec( type := "T_FUNC_EXPR",
                       variadic := false,
