...
expect_trees := [
                  ...
                  rec( type := "T_FUNC_EXPR",
                       ...
                       stats := rec( statements := [ rec( lvar := 1,
                                                     ...
                                                     rec( statements := [ rec( lvar := 1,
                                                                               rhs := rec( cycles := [ [ rec( type := "T_INTEXPR",
                                                                                                              value := 1 ),
                                                                                                         rec( type := "T_INTEXPR",
                                                                                                              value := 2 ),
                                                                                                         rec( type := "T_INTEXPR",
                                                                               ...
                                                                               type := "T_ASS_LVAR" ),
                                                                          rec( lvar := 1,
                                                                               rhs := rec( list := [ rec( type := "T_INTEXPR",
                                                                                                          value := 1 ) ],
                                                                                           type := "T_LIST_EXPR" ),
                                                                               type := "T_ASS_LVAR" ),
                                                                          rec( lvar := 1,
                                                                               rhs := rec( first := rec( type := "T_INTEXPR",
                                                                                                         value := 1 ),
                                                                                           last := rec( type := "T_INTEXPR",
                                                                                                        value := 4 ),
                                                                                           type := "T_RANGE_EXPR" ),
                                                                               type := "T_ASS_LVAR" ),
                                                                          rec( lvar := 1,
                       ...
                       stats := rec( statements := [ rec( lvar := 3,
                                                     ...
                                                     rec( statements := [ rec( lvar := 3,
                                                                          ...
                                                                          rec( lvar := 3,
                                                                               ...
                                                                               type := "T_ASS_LVAR" ),
                                                                          rec( lvar := 3,
                                                                               rhs := rec( left := rec( type := "T_INTEXPR",
                                                                                                        value := 1 ),
                                                                                           right := rec( lvar := 1,
                                                                                                         type := "T_REFLVAR" ),
                                                                                           type := "T_QUO" ),
                                                     ...
                                                     rec( branches := [ rec( condition := rec( type := "T_TRUE_EXPR" ),
                                                                        ...
                                                                        rec( condition := rec( type := "T_FALSE_EXPR" ),
                                                                             stats := rec( obj := rec( type := "T_INTEXPR",
                                                                                           ...
                                                                                           type := "T_RETURN_OBJ" ) ) ],
                                                          type := "T_IF_ELIF" ),
                                                     rec( branches := [ rec( condition := rec( left := rec( lvar := 1,
                                                                                                            type := "T_REFLVAR" ),
                  ...
                  rec( argnams := [  ],
                       ...
                       narg := 0,
                       nloc := 3,
                       stats := rec( statements := [ rec( body := [ rec( lvar := 2,
                                                                         rhs := rec( lvar := 1,
                                                                                     type := "T_REFLVAR" ),
                                                                         type := "T_ASS_LVAR" ),
                                                                  ],
                                                          collection := rec( lvar := 3,
                                                                             type := "T_REFLVAR" ),
                                                          type := "T_FOR",
                                                          variable := rec( lvar := 1,
                                                                           type := "T_REFLVAR" ) ),
                                                     rec( body := [ rec( lvar := 2,
                                                          ...
                                                          variable := rec( lvar := 1,
                                                                           type := "T_REFLVAR" ) ),
                                                     rec( body := [ rec( statements := [ rec( lvar := 2,
                                                                                              rhs := rec( lvar := 1,
                                                                                                          type := "T_REFLVAR" ),
                                                                                              type := "T_ASS_LVAR" ),
                                                                                         rec( lvar := 2,
                                                     ...
                                                     rec( body := [ rec( lvar := 2,
                                                          ...
                                                          collection := rec( first := rec( type := "T_INTEXPR",
                                                                                           value := 1 ),
                                                                             last := rec( type := "T_INTEXPR",
                                                                                          value := 2 ),
                                                                             type := "T_RANGE_EXPR" ),
                  ...
                  rec( argnams := [  ],
                       locnams := [ "i" ],
                       name := "stat_test_while",
                       narg := 0,
                       nloc := 1,
                       stats := rec( statements := [ rec( body := [ rec( lvar := 1,
                                                                         rhs := rec( type := "T_INTEXPR",
                                                                                     value := 1 ),
                                                                         type := "T_ASS_LVAR" ) ],
                                                     ...
                                                     rec( body := [ rec( lvar := 1,
                                                          ...
                                                          condition := rec( type := "T_TRUE_EXPR" ),
                                                          type := "T_WHILE2" ),
                                                     rec( body := [ rec( statements := [ rec( lvar := 1,
                                                                                              rhs := rec( type := "T_INTEXPR",
                                                                                                          value := 1 ),
                                                                                              type := "T_ASS_LVAR" ),
                                                                                         rec( lvar := 1,
                  ...
                  rec( argnams := [  ],
                       locnams := [  ],
                       name := "stat_test_return_obj",
                       narg := 0,
                       nloc := 0,
                       stats := rec( statements := [ rec( obj := rec( type := "T_INTEXPR",
                                                                      value := 4 ),
                                                          type := "T_RETURN_OBJ" ) ],
                                     type := "T_SEQ_STAT" ),
                       type := "T_FUNC_EXPR",
                       ...
                       stats := rec( statements := [ rec( lvar := 1,
                                                     ...
                                                     rec( lvar := 2,
                                                          rhs := rec( argnams := [  ],
                                                                      ...
                                                                      narg := 0,
                                                                      nloc := 0,
                                                                      stats := rec( statements := [ rec( hvar := 65537,
                                                                                                         rhs := rec( type := "T_INTEXPR",
                                                                                                                     value := 6 ),
                                                                                                         type := "T_ASS_HVAR" ),
                                                                                                    rec( hvar := 65537,
                       ...
                       stats := rec( statements := [ rec( lvar := 1,
                                                     ...
                                                     rec( list := rec( lvar := 1,
                                                          ...
                                                          rhs := rec( list := [ rec( type := "T_INTEXPR",
                                                                      ...
                                                                      type := "T_LIST_EXPR" ),
                                                          type := "T_ASS2_LIST" ),
                                                     rec( statements := [ rec( list := rec( lvar := 1,
                                                                                            type := "T_REFLVAR" ),
                                                                               refs := [ rec( type := "T_INTEXPR",
                                                                                              value := 1 ),
                                                                                         rec( type := "T_INTEXPR",
                          ...
                          stats := rec( statements := [ rec( lvar := 1,
                                                        ...
                                                        rec( expression := rec( string := "bla",
                                                             ...
                                                             record := rec( lvar := 1,
                                                                            type := "T_REFLVAR" ),
                                                             type := "T_UNB_REC_EXPR" ),
                                                        rec( statements := [ rec( record := rec( lvar := 1,
                                                                                                 type := "T_REFLVAR" ),
                  ...
                  rec( argnams := [  ],
                       ...
                       stats := rec( statements := [ rec( lvar := 1,
                                                          rhs := rec( keyvalue := [  ],
                                                                      type := "T_REC_EXPR" ),
                                                          type := "T_ASS_LVAR" ),
                                                     rec( comobj := rec( lvar := 1,
                                                                         type := "T_REFLVAR" ),
                                                          rnam := "a",
                                                          type := "T_ASS_COMOBJ_NAME" ),
                                                     rec( comobj := rec( lvar := 1,
                                                                         type := "T_REFLVAR" ),
                                                          name := rec( type := "T_INTEXPR",
                                                                       value := 12 ),
                                                          type := "T_UNB_COMOBJ_NAME" ),
                                                     rec( comobj := rec( lvar := 1,
                                                                         type := "T_REFLVAR" ),
                                                          rnam := "a",
                                                          type := "T_ASS_COMOBJ_NAME" ),
                  ...
                  rec( argnams := [  ],
                       ...
                       stats := rec( statements := [ rec( lvar := 1,
                                                     ...
                                                     rec( lvar := 1,
                                                          rhs := rec( args := [ rec( type := "T_INTEXPR",
                                                                                     value := 1 ) ],
                                                                      funcref := rec( lvar := 2,
                                                                                      type := "T_REFLVAR" ),
                                                                      type := "T_FUNCCALL_1ARGS" ),
                                                          type := "T_ASS_LVAR" ),
                                                     rec( args := [ rec( type := "T_INTEXPR",
                                                                         value := 1 ) ],
                                                          funcref := rec( lvar := 1,
                                                                          type := "T_REFLVAR" ),
