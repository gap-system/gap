...
gap> ExtRepOfObj( LeftQuotient( w*w, w ) );
[ 1, 1, 3, 1, 4, 1, 5, 2, 6, 1, 7, 1, 8, 1, 9, 1, 11, 1 ]
...
gap> ExtRepOfObj( Comm( w, l[1] ) );
[ 9, 1 ]

gap> ExtRepOfObj( LeftQuotient( w, w ) );   
[  ]

gap> ExtRepOfObj( LeftQuotient( w, l[1] ) );
[ 2, 1, 3, 1, 4, 1, 5, 2, 6, 1, 7, 1, 8, 1, 9, 1, 11, 1 ]

gap> ExtRepOfObj( One(grp) );
[  ]

gap> ExtRepOfObj( w / w );
[  ]

gap> ExtRepOfObj( w / l[1] );
...
gap> STOP_TEST( "rwspcsng.tst", 562567390 );
