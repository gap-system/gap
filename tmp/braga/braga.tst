...
##
#H  @(#)$Id: braga.tst,v 1.2 1999/08/25 18:19:21 andrews Exp $
##
#Y  Copyright (C)  1998,  Lehrstuhl D fuer Mathematik,  RWTH Aachen,  Germany
##

gap> START_TEST("$Id: braga.tst,v 1.2 1999/08/25 18:19:21 andrews Exp $");
...
MappingByFunction( Rees Zero Matrix Semigroup over Monoid(
[ (), (1,2), 0 ], ... ), <quotient of SemigroupIdeal(
[ Transformation( [ 1, 1, 3 ] )
 ] ) by SemigroupCongruence( ... )>, function( x ) ... end )
gap> Source( irms);
Rees Zero Matrix Semigroup over Monoid( [ (), (1,2), 0 ], ... )
gap> q = Range( irms );
true
...
gap> STOP_TEST( "braga.tst", 60470599 );
