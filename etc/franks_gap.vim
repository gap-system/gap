...
"hi gapListDelimiter cterm=bold ctermfg=8
"hi gapParentheses cterm=bold ctermfg=12
"hi gapSublist cterm=bold ctermfg=14
...
vmap <ESC>}F22 !(mv -f bla.xml bla1.xml; sed -e "s/^\#\#  \(.*\)/\1/" >bla.xml;xterm -e vi bla.xml ;sed -e "s/\(.*\)/\#\#  \1/" bla.xml)<CR><CR>
